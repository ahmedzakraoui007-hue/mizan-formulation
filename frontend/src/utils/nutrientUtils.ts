...
export const getNutrientUnit = (key: string): string => {
  ...
  if (k.includes("%") || k.includes("protéine") || k.includes("fibre") || k.includes("cellulose") || k.includes("matière grasse") || k.includes("amidon") || k.includes("sucres") || k.includes("crude protein") || k.includes("crude fat") || k.includes("crude fibre") || k.includes("ash") || k.includes("starch") || k.includes("sugars") || k.includes("ndf") || k.includes("adf") || k.includes("adl") || k.includes("lignin") || k.includes("cell wall")) return "%";
